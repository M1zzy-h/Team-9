                    ...
                    <main class="site-main">
                        <div class="product-gallery ">
                            <div class="single-image-wrapper">
                                <img src="home\img\product images/stickseason.jpg" id="single-image" alt="">
                            </div>
                  
                        </div>
                        <div class="product-info">
                            <h2 class="product-title">Stick Season</h2>
                            <h3>Noah Kahan</h3>
                            ...
                            <div class="album-description"
                                   <p>Following the release of his second album, Noah continued to write and record, unlocking a new level of himself as an artist and songwriter. Rife with fluttering guitar melodies, inviting vocals, and homey imagery of the Northeast on the verge of changing seasons, it represents a massive turning point for him. Kahan's relationship with his career was altered, his conviction for storytelling and a pursuit of a more organic sound that aligned with the folk music of his upbringing had firmly arrived.</p>
                                   </div>
                                ...
                                <div class="variations">
                                 ...
                                 <div class="cart-button">
                                        ...
                                        <p class="product-description">
                                            Product Dimensions ‏ : ‎ 31.3 x 31.2 x 0.7 cm; 535.24 g<br>
                                            Manufacturer ‏ : ‎ Island<br>
                                            Item model number ‏ : ‎ 0NHF1344<br>
                                            Label ‏ : ‎ Island<br>
                                            Number of discs ‏ : ‎ 2              
                                        </p>
                                </div>
