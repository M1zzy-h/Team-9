                    ...
                    <main class="site-main">
                        <div class="product-gallery ">
                            <div class="single-image-wrapper">
                                <img src="home\img\product images/borntodie.jpg" id="single-image" alt="">
                            </div>
                        </div>
                        <div class="product-info">
                            <h2 class="product-title">Born to die</h2>
                            <h3>Lana Del Rey</h3>
                                ...
                                <div class="variations">
                                 ...
                                 <div class="cart-button">
                                        ...
                                        <p class="product-description">
                                            Product Dimensions ‏ : ‎ 31.39 x 31.39 x 0.79 cm; 235.87 g<br>
                                            Manufacturer ‏ : ‎ Import<br>
                                            Item model number ‏ : ‎ 28930756<br>
                                            Label ‏ : ‎ Import<br>
                                            Number of discs ‏ : ‎ 1
                                        </p>
                                </div>
