                    ...
                    <main class="site-main">
                        <div class="product-gallery ">
                            <div class="single-image-wrapper">
                                <img src="home\img\product images/igor.jpg" id="single-image" alt="">
                            </div>
                        
                        </div>
                        <div class="product-info">
                            <h2 class="product-title">IGOR</h2>
                            ...
                            <div class="product-review">
                                <ul class="product-star">
                                    ...
                                    <li><i class="bi bi-star-fill"></i></li>
                                    <li><i class="bi bi-star-fill"></i></li>
                                    <li><i class="bi bi-star-full"></i></li>
                                </ul>
                                <span>7 reviews</span>
                            </div>
                            ...
                            <div class="album-description"
                                   <p>Fifth studio album by the American hip-hop artist, featuring guest appearances from Playboi Carti, Lil Uzi Vert, Solange, Kanye West, and Jerrod Carmichael, along with backing vocals from Santigold, Jessy Wilson, La Roux, CeeLo Green, Charlie Wilson, Slowthai, and Pharrell, among others. The album includes the single 'Earfquake'.</p>
                                   </div>
                                ...
                                <div class="variations">
                                 ...
                                 <div class="cart-button">
                                        ...
                                        <p class="product-description">
                                            Product Dimensions ‏ : ‎ 31.24 x 0.51 x 30.73 cm; 317.51 g<br>
                                            Manufacturer ‏ : ‎ Columbia<br>
                                            Item model number ‏ : ‎ IPMSKG-DOYK-00<br>
                                            Label ‏ : ‎ Columbia<br>
