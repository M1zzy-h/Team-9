                    ...
                    <main class="site-main">
                        <div class="product-gallery ">
                            <div class="single-image-wrapper">
                                <img src="home\img\product images/1989.jpg" id="single-image" alt="">
                            </div>
                          
                        </div>
                        <div class="product-info">
                            <h2 class="product-title">1989</h2>
                            <h3>Taylor Swift</h3>
                            ...
                            <div class="album-description"
                                   <p>1989 (Taylor’s Version) Vinyl , 21 Songs, Including 5 previously unreleased songs from The Vault, Collectible album jacket with unique front and back cover art, 2 Crystal Skies Blue vinyl discs, Collectible album sleeves including lyrics and never-before-seen photos</p>
                                   </div>
                                ...
                                <div class="variations">
                                 ...
                                 <div class="cart-button">
                                        ...
                                        <p class="product-description">
                                            Product Dimensions ‏ : ‎ 32 x 31.9 x 0.8 cm; 589.67 g<br>
                                            Manufacturer ‏ : ‎ Universal Music<br>
                                            Manufacturer reference ‏ : ‎ 0602455542144<br>
