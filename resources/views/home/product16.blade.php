                    ...
                    <main class="site-main">
                        <div class="product-gallery ">
                            <div class="single-image-wrapper">
                                <img src="home\img\product images/mmfood.jpg" id="single-image" alt="">
                            </div>
                            
                        </div>
                        <div class="product-info">
                            <h2 class="product-title">MM..Food</h2>
                            <h3>MF DOOM</h3>
                                ...
                                <div class="variations">
                                 ...
                                 <div class="cart-button">
                                        ...
                                        <p class="product-description">
                                            Product Dimensions ‏ : ‎ 1.14 x 31.65 x 31.55 cm; 603.28 g<br>
                                            Manufacturer ‏ : ‎ Rhymesayers<br>
                                            Label ‏ : ‎ Rhymesayers<br>
