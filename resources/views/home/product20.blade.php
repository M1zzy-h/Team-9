                    ...
                    <main class="site-main">
                        <div class="product-gallery ">
                            <div class="single-image-wrapper">
                                <img src="home\img\product images/yesigned.jpg" id="single-image" alt="">
                            </div>
                        ...
                        <div class="product-info">
                            <h2 class="product-title">YE [SIGNED]</h2>
                            <h3>Kanye West</h3>
                            ...
                            <div class="album-description"
                                   <p>Eighth studio album by the American rapper. The record peaked at #2 in the UK Albums Chart and contains guest vocals from PartyNextDoor,Ty Dolla Sign and Kid Cudi. The album was supported by the release of the lead single 'Yikes'.</p>
                                   </div>
                                ...
                                <div class="variations">
                                 ...
                                 <div class="cart-button">
                                        ...
                                        <p class="product-description">
                                            Product Dimensions ‏ : ‎ 31.29 x 31.39 x 0.79 cm; 235.87 g<br>
                                            Manufacturer ‏ : ‎ Virgin<br>
                                            Item model number ‏ : ‎ UM-6778469<br>
                                            Original Release Date ‏ : ‎ 2018<br>
                                            Label ‏ : ‎ Virgin<br>
