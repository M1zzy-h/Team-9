                    ...
                    <main class="site-main">
                        <div class="product-gallery ">
                            <div class="single-image-wrapper">
                                <img src="home\img\product images/astroworld.jpg" id="single-image" alt="">
                            </div>
                           
                        </div>
                        <div class="product-info">
                            <h2 class="product-title">Astroworld</h2>
                            <h3>Travis Scott</h3>
                            ...
                            <div class="album-description"
                                   <p>Third studio album by the American hip-hop artist. The album features guest vocals from Kid Cudi, Frank Ocean, Drake, The Weeknd, James Blake, Swae Lee, Gunna, Philip Bailey, Nav, 21 Savage, Quavo, Takeoff, Juice Wrld, Sheck Wes, and Don Toliver, among others, and features the singles 'Butterfly Effect', 'Sicko Mode', 'Yosemite' and 'Wake Up'.</p>
                                   </div>
                                ...
                                <div class="variations">
                                 ...
                                 <div class="cart-button">
                                        ...
                                        <p class="product-description">
                                            Product Dimensions ‏ : ‎ 31.24 x 31.24 x 0.76 cm; 476.27 g<br>
                                            Manufacturer ‏ : ‎ Rca<br>
                                            Item model number ‏ : ‎ 1907 5888361<br>
                                            Label ‏ : ‎ Rca<br>
