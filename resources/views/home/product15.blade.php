                    ...
                    <main class="site-main">
                        <div class="product-gallery ">
                            <div class="single-image-wrapper">
                                <img src="home\img\product images/blonde.jpg" id="single-image" alt="">
                            </div>
                           
                        </div>
                        <div class="product-info">
                            <h2 class="product-title">Blonde</h2>
                            <h3>Frank Ocean</h3>
                            ...
                            <div class="album-description"
                                   <p>Frank Ocean’s Vinyl “Blonde”, comes in paper sleeves and has 1 pink and 1 blue disc.</p>
                                   </div>
                                ...
                                <div class="variations">
                                 ...
                                 <div class="cart-button">
                                        ...
                                        <p class="product-description">
                                            Product Dimensions ‏ : ‎ 15 x 13 x 1 inches; 1.95 Pounds<br>
                                            Manufacturer ‏ : ‎ Blonded<br>
                                            Run time ‏ : ‎ 1 hour and 14 minutes<br>
                                            Label ‏ : ‎ Blonded<br>
                                            Number of discs ‏ : ‎ 2 
                                        </p>
                                </div>
