                    ...
                    <main class="site-main">
                        <div class="product-gallery ">
                            <div class="single-image-wrapper">
                                <img src="home\img\product images/callmeifyougetlost.jpg" id="single-image" alt="">
                            </div>
                
                        </div>
                        <div class="product-info">
                            <h2 class="product-title">Call Me If You Get Lost</h2>
                            ...
                            <div class="album-description"
                                   <p>Sixth studio album by the American rapper, featuring Pharrell Williams, Brent Faiyaz and Lil Wayne. The album includes the previously-released songs 'Lumberjack' and 'Wusyaname' as well as 'Juggernaut'.</p>
                                   </div>
                                ...
                                <div class="variations">
                                 ...
                                 <div class="cart-button">
                                        ...
                                        <p class="product-description">
                                            Product Dimensions ‏ : ‎ 31.24 x 0.76 x 30.73 cm; 498.95 g<br>
                                            Manufacturer ‏ : ‎ Columbia<br>
                                            Item model number ‏ : ‎ 2022-04-15<br>
                                            Label ‏ : ‎ Columbia<br>
                                            Number of discs ‏ : ‎ 2
                                        </p>
                                </div>
