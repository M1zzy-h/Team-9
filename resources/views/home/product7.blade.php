                    ...
                    <main class="site-main">
                        <div class="product-gallery ">
                            <div class="single-image-wrapper">
                                <img src="home\img\product images/cranberries.jpg" id="single-image" alt="">
                            </div>
            
                        </div>
                        <div class="product-info">
                            <h2 class="product-title">Everybody else is doing it, so why can't we</h2>
                            ...
                            <div class="album-description"
                                   <p>Everybody Else Is Doing It, So Why Can't We? is the debut studio album by Irish rock band The Cranberries. Released on 1 March 1993, it was their first full-length album after having released four EPs, and is also their first major label release.</p>
                                   </div>
                                ...
                                <div class="variations">
                                 ...
                                 <div class="cart-button">
                                        ...
                                        <p class="product-description">
                                            Product Dimensions ‏ : ‎ 31.29 x 31.19 x 0.79 cm; 235.87 g<br>
                                            Manufacturer ‏ : ‎ UMC - Uni/Island<br>
                                            Item model number ‏ : ‎ 6750577<br>
                                            Label ‏ : ‎ UMC - Uni/Island<br>
