                    ...
                    <main class="site-main">
                        <div class="product-gallery ">
                            <div class="single-image-wrapper">
                                <img src="home\img\product images/laurynhill.jpg" id="single-image" alt="">
                            </div>
                            
                        </div>
                        <div class="product-info">
                            <h2 class="product-title">The Misseducation of Lauryn Hill</h2>
                            <h3>Lauryn Hill</h3>
                            ...
                            <div class="album-description"
                                   <p>Lauryn Hill's debut Solo album The Miseducation Of Lauryn Hill pressed on heavyweight 180 gram black vinyl, double LP.</p>
                                   </div>
                                ...
                                <div class="variations">
                                 ...
                                 <div class="cart-button">
                                        ...
                                        <p class="product-description">
                                            Product Dimensions ‏ : ‎ 0.51 x 31.57 x 31.37 cm; 480.81 g<br>
                                            Manufacturer ‏ : ‎ Sony Music Cmg<br>
                                            Manufacturer reference ‏ : ‎ 88875194221<br>
                                            Label ‏ : ‎ Sony Music Cmg<br>
                                           Number of discs ‏ : ‎ 2          
                                        </p>
                                </div>
                            </form>
