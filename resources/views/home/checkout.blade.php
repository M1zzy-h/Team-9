...
<div class="container">
    ...
    <h1>Pay using Your Card - total Amount £<span id="cart-total">0.00</span></h1>
                    ...
                    <form 
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                ...
                                <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now (£<span id="cart-total">0.00</span>)</button>
