                    ...
                    <main class="site-main">
                        <div class="product-gallery ">
                            <div class="single-image-wrapper">
                                <img src="home\img\product images/darktwistedfantasy.jpg" id="single-image" alt="">
                            </div>
                      
                        </div>
                        <div class="product-info">
                            <h2 class="product-title">My Beautiful Dark Twisted Fantasy</h2>
                            <h3>Kanye West</h3>
                                ...
                                <div class="variations">
                                 ...
                                 <div class="cart-button">
                                        ...
                                        <p class="product-description">
                                            Product Dimensions ‏ : ‎ 31.5 x 31.39 x 1.5 cm; 781.88 g<br>
                                            Manufacturer ‏ : ‎ Import<br>
                                            Item model number ‏ : ‎ MASBSCOT-CANARDPOW<br>
                                            Label ‏ : ‎ Import<br>
